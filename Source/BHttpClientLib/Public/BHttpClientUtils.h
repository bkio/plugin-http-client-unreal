...
#if PLATFORM_MAC
#include "ThirdParty/OpenSSL/1.1.1k/Mac/openssl/err.h"
#include "ThirdParty/OpenSSL/1.1.1k/Mac/openssl/md5.h"
#include "ThirdParty/OpenSSL/1.1.1k/Mac/openssl/ssl.h"
#include "ThirdParty/OpenSSL/1.1.1k/Mac/openssl/x509v3.h"
#elif PLATFORM_LINUX
...
#else
#include "ThirdParty/OpenSSL/1.1.1k/Include/Win64/VS2015/openssl/err.h"
#include "ThirdParty/OpenSSL/1.1.1k/Include/Win64/VS2015/openssl/md5.h"
#include "ThirdParty/OpenSSL/1.1.1k/Include/Win64/VS2015/openssl/ssl.h"
#include "ThirdParty/OpenSSL/1.1.1k/Include/Win64/VS2015/openssl/x509v3.h"
#endif
...
#define USE_IF2IP
    ...
    inline Client::Client(const char* scheme_host_port,
        ...
        if (std::regex_match(scheme_host_port, m, re)) {
            ...
            if (is_ssl) {
#ifdef CPPHTTPLIB_OPENSSL_SUPPORT
                //printf("----------------------------------------------------------------------------------------- CPPHTTPLIB_OPENSSL_SUPPORT:YES\nscheme  : %s\nhost    : %s\nport_str: %s\n\n\n", scheme.c_str(), host.c_str(), port_str.c_str());
